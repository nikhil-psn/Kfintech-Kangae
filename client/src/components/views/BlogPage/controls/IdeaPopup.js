...
import {Dialog, DialogTitle, Paper, makeStyles, DialogContent } from '@material-ui/core';
...
export default function Popup(props){
    ...
    return (
        <Dialog open={props.openPopup} maxWidth="md" onBackdropClick={()=>{props.setOpenPopup(false)}}>
